...
import { ArrowLeft, Package, Loader2, Eye, Calendar, DollarSign, User, MapPin } from 'lucide-react'
...
export default function OrdersPage() {
  ...
  const fetchOrders = async () => {
    try {
      setLoading(true)
      const response = await fetch(`/api/orders?includeCancelled=${includeCancelled}`)
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Administra y procesa todos los pedidos</p>
          </div>
                  ...
                  <Card key={order.id}>
                    ...
                    <CardContent>
                      ...
                      <div className="flex items-center gap-4 text-xs text-muted-foreground pt-4 border-t">
                        ...
                        {order.shipped_at && (
                          <span>Enviado: {formatDate(order.shipped_at)}</span>
                        )}
                        {order.delivered_at && (
